      ...
      <aside style={{
        ...
        {user && (
          <div style={{ padding: '16px 12px', borderTop: '1px solid var(--border)' }}>
            ...
            {!stravaConnected && (
              <a href="/.netlify/functions/auth-strava?action=connect" style={{
                display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px',
                borderRadius: 8, fontSize: 13, color: 'white', background: 'var(--orange)',
                border: 'none', cursor: 'pointer', textDecoration: 'none', marginBottom: 8
              }}>🔗 Connecter Strava</a>
            )}
            <a href="/.netlify/functions/logout" style={{
              display: 'flex', alignItems: 'center', gap: 8, padding: '8px 12px',
              borderRadius: 8, fontSize: 13, color: 'var(--text3)', background: 'transparent',
